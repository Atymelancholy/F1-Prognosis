...
<img width="1182" height="607" alt="Untitled (3)" src="https://github.com/user-attachments/assets/1d13a040-745b-476b-be14-ac863dd2c603" />

## Глоссарий

| Термин          | Определение                                                                                             |
|:----------------|:--------------------------------------------------------------------------------------------------------|
| Посетитель           | Неаутентифицированный пользователь приложения.                                                          |
...
| Актер         | Описание                                                                                                                              |
|---------------|---------------------------------------------------------------------------------------------------------------------------------------|
| Посетитель         | Неаутентифицированный пользователь. Может просматривать календарь и рейтинг.                                                          |
...
- Посетитель вводит требуемые данные и подтверждает отправку формы.
...
**Описание**. Вариант использования позволяет Посетитель или Пользователю просмотреть список предстоящих и завершённых Гран-при.
...
**Основной поток**.
- Актeр переходит на вкладку "Leaderboard".
...
## 2.8 Управление календарём Гран-при для администратора
...
## 2.9 Внести результаты Гран-при для администратора
