...
- [2.5 Создать / отредактировать прогноз](#25-создать-/-отредактировать прогноз)
- [2.6 Просмотреть профиль](#26-посмотреть-профиль)
- [2.7 Выйти из учетной записи](#27-выйти-из-учетной-записи)
- [2.8 Управление календарём Гран-при (Админ)](#28-Управление-календарём-Гран-при-(Админ))
- [2.9 Внести результаты Гран-при (Админ)](#29-Внести-результаты-Гран-при-(Админ))
...
## 2.5 Создать / отредактировать прогноз
